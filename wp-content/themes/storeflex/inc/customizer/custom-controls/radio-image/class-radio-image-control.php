...
if ( ! class_exists( 'StoreFlex_Control_Radio_Image' ) ) {
     ...
     * @since 1.0.0
     */
	class StoreFlex_Control_Radio_Image extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_style( 'storeflex-radio-image-style', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radio-image.css', null );
            wp_enqueue_script( 'storeflex-radio-image-script', get_template_directory_uri() . '/inc/customizer/custom-controls/radio-image/radio-image.js', array( 'jquery' ), false, true );
        }
